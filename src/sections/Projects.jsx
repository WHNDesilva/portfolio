...
// };
// Projects.jsx
// Filtered project grid with category buttons.
//
// ARROW BUTTON BEHAVIOUR:
//   • Clicking the ArrowUpRight on a project card image (hover overlay) OR
//     the arrow in the card body OPENS a modal popup.
//   • The modal shows an image slideshow (one image per slide, with caption/description).
//     Navigate slides with ← / → buttons or dot indicators — like the Testimonials carousel.
//   • A "View Full Case Study" button inside the modal goes to /blog#<projectId>.
//   • Click the backdrop or X to close.
...
const projects = [
  {
    ...
    category: "frontend",
    status: "complete",
    github: "https://github.com/hirunidesilva/portfolio",
    slides: [
      { image: "/projects/project1.png",   caption: "Hero section — animated dark-themed landing page with glowing accents." },
      { image: "/projects/project1b.png",  caption: "Projects section — category filter buttons with teal active state." },
      { image: "/projects/project1c.png",  caption: "Figma design file — component layout and colour system." },
      { image: "/projects/project1.png",   caption: "Hero section — animated dark-themed landing page with glowing accents." },
    ],
  },
  {
